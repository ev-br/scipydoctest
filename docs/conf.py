# -*- coding: utf-8 -*-
#
# pytest-scipydoctest documentation build configuration file, created by
...
project = 'pytest-scipydoctest'
copyright = '2015, Evgeni Burovski'
...
man_pages = [
    (master_doc, 'pytest-cookiecutterplugin_name', 'pytest-scipydoctest Documentation',
     [author], 1)
]
